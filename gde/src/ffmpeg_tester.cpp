...
{
    godot::ClassDB::bind_method(D_METHOD("get_ffmpeg_version"), &FFmpegTester::get_ffmpeg_version);
    godot::ClassDB::bind_method(D_METHOD("is_ffmpeg_available"), &FFmpegTester::is_ffmpeg_available);
    godot::ClassDB::bind_method(D_METHOD("get_libavutil_version"), &FFmpegTester::get_libavutil_version);
    godot::ClassDB::bind_method(D_METHOD("get_libavcodec_version"), &FFmpegTester::get_libavcodec_version);
    godot::ClassDB::bind_method(D_METHOD("get_libavformat_version"), &FFmpegTester::get_libavformat_version);
}
